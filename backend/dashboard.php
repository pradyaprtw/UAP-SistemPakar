            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Manage your Website here so easily</h6>
                  <br>
                  ...
                  <div class="card card-dark-blue">
                    <div class="card-body">
                       <?php
                        ...
                        $check2 = "SELECT COUNT(id) AS total2 FROM users";
                        $checkrun2 = mysqli_query($dbcon,$check2);
                        $checkrow2 = mysqli_fetch_assoc($checkrun2);
                        $total2 = $checkrow2['total2'];
