...
<div class="modal fade" id="image-modal" tabindex="-1" role="dialog">
  ...
  $result_count = mysqli_query($dbcon,"SELECT COUNT(*) As total_records FROM `diagnosis`");
  $total_records = mysqli_fetch_array($result_count);
  $total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
  $second_last = $total_no_of_pages - 1; // total page minus 1
$counter = 1;
    $result = mysqli_query($dbcon,"SELECT * FROM `diagnosis` ORDER BY id DESC LIMIT $offset, $total_records_per_page");
    while($row = mysqli_fetch_array($result)){
                ...
                <td>".$counter++."</td>
                  ...
                  <td><a href='delete_diagnosis.php?id=".$row['id']."'><button class='btn btn-danger btn-sm'>Delete</button></a></td>
                </tr>";
              }
            ?>
