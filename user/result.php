        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                   ...
                   <p>Below is your diagonis results</p>
                    
                    <div class="results" >
                        <?php 

                            $sqld = "SELECT * FROM diagnosis WHERE email = '$email' LIMIT 1";
                            $rund = mysqli_query($dbcon,$sqld);
                            $rowd = mysqli_fetch_assoc($rund);
                                ?>

                                    <h4 style="font-family: Bold;border-left: 4px solid #153097;padding-left: 10px;"><?php echo $rowd['recommendation']; ?></h4>
                        ...
                        <a href="appointment.php"><button class="btn btn-primary btn-block">Book Appointment with Doctor</button></a>
                    </div>
