        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                   ...
                   <a href="appointment.php" style="float:right;"><button style="background-color: #153097 !important;border:none;border-radius: 0px;" class="btn btn-primary">Book Appointment with Doctor</button></a>
